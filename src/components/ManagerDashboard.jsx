...
export default function ManagerDashboard({ token, api, passwordChanged = true }) {
  ...
  // Custom Date Time formatter for Stacked Layout
  ...
  return (
    <div>
      <style>{`
        ...
        /* Badges */
        .status-badge { padding: 4px 8px; border-radius: 20px; font-size: 11px; font-weight: 600; display: inline-block; text-transform: capitalize; min-width: 70px; text-align: center; }
        ...
        /* Universal Table Layout (Optimized for Team Leaves fitting) */
        .styled-table { width: 100%; border-collapse: collapse; font-size: 13px; table-layout: auto; }
        .styled-table th, .styled-table td { padding: 12px 10px; border-bottom: 1px solid #f2f2f2; vertical-align: middle; }
        .styled-table th { background-color: #f8f9fa; color: #334155; font-weight:600; text-align:left; border-bottom: 2px solid #e2e8f0; }
                ...
                <table className="styled-table">
                    <thead>
                        <tr>
                            ...
                            <th style={{textAlign:'center'}}>Manager</th>
                            <th style={{textAlign:'center'}}>HR</th>
                            <th style={{textAlign:'center'}}>Final Status</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        {teamLeaves.map(l => {
                            ...
                            <tr key={l._id}>
                                ...
                                <td>
                                    ...
                                    <div style={{fontSize:11, color:'#64748b', marginTop: 4, textTransform: "uppercase", fontWeight: 600}}>
                                ...
                                <td style={{maxWidth:'200px'}}>
                                    <div style={{fontSize:12, color:'#475569', lineHeight:'1.4', wordWrap: 'break-word', marginBottom: l.attachment_url ? 8 : 0}}>
                                ...
                                {/* Action Buttons - Always Visible & Stacked */}
                                <td>
